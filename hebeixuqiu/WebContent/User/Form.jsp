...
<script type="text/javascript">
	function addInput(){
		...
		fdiv.innerHTML+='<div style="float: float;"><input type="text" name="c3" value="${param.GongjianCompany }"/><input type="button" onclick="del(this)" value="删除"/><div>';
	}
...
<body onload="setup();preselect('陕西省');promptinfo();">
	<form action="${pageContext.request.contextPath }/severLet/formSeverlet" method="post">
		<table border="1" width="80%" align="center">
			<tr>
				<td>平台名称：</td>
				<td><input type="text" name="platname" value="${sessionScope.user.platname}"/></td>
				<td>平台编号：</td>
				<td><input type="text" name="platnum" value="${sessionScope.user.platnum}"/></td>
			</tr>
			<tr>
				<td>批准年月：</td>
				<td><input type="text" name="pizhuntime" value="${sessionScope.user.pizhuntime}"/></td>
				<td>批准文号：</td>
				<td><input type="text" name="pizhunwenhao" value="${sessionScope.user.pizhunwenhao}"/></td>
			</tr>
			<tr>
				<td>技术领域：</td>
				<td><input type="text" name="jishulingyu" value="${sessionScope.user.jishulingyu}"/></td>
			</tr>
			<tr>
				<td>平台级别：</td>
				<td>
			...
			<tr>
				...
				<td colspan="7" style="text-align: left">
					...
					<input type="radio" id="Other" value="其他" name="EconoyServing"/>其他
				</td>
				
				<!-- 
								<td colspan="7"><input style="width: 100%;height: 100%" type="text" name="EconoyServing"/></td>
			...
			<tr>
				...
				<!--  
								<td colspan="7"><input style="width: 100%;height: 100%" type="text" name="xueke"/></td>
...
<!-- 					</div> -->
			...
			<tr>
				<td colspan="9">
					...
					&nbsp;&nbsp;&nbsp;&nbsp;
					<input style="height: 35px;width: 65px;font-size: 20px;cursor: pointer;" type="submit" value="提交" onclick="display()"/>
				</td>
			</tr>
		</table>
	</form>
